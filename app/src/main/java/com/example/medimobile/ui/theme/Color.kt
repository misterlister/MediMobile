...
val MediGreen = Color(0xFF0CA60C) // Green colour to represent confirmation
val MediYellow = Color(0xFFFFCC00) // Yellow colour to represent incomplete sections
...
val InactiveColour = Color(0xFF707070) // Grey colour for inactive buttons/menus
